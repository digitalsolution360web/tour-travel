...
export default function StickyBottomBar() {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white shadow-[0_-4px_20px_rgba(4,72,78,0.15)] border-t border-gray-100 flex items-stretch h-16">
      {/* Book Now - Left */}
      <Link
        href="/contact"
        className="flex-[1.5] bg-accent text-primary flex items-center justify-center gap-2 border-r border-white/20"
      >
        <span className="text-sm font-bold uppercase tracking-widest text-primary/90">Book Now</span>
      </Link>
